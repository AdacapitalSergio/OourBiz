...
export default function NossosProfissionais() {
  return (
    <section className="section-nossosp">
        ...
        <div className="div-continner-nossos">
            <article className="article-nossosp">
                <img src={ ceo } alt="Imagem" className="imagem-nossosp" />
                <h4 className="h4-nossosp">Sérgio Lélis<br />CEO</h4>
                <p className="p-nossosp">
                    Formado em Gestão de Empresas pela Universidade Agostinho Neto e docente da 
            ...
            <article className="article-nossosp">
                <img src={ sonia } alt="Imagem" className="imagem-nossosp" />
                <h4 className="h4-nossosp">Sónia Adelaide<br />Assistente Administrativa</h4>
                <p className="p-nossosp">
                    Formada em Informática e Gestão pelo Instituto Superior Politécnico 
                    Independente (ISPI), 
                </p>
                <p className="p-nossosp">
            ...
            <article className="article-nossosp">
                <img src={ david } alt="Imagem" className="imagem-nossosp" />
                <h4 className="h4-nossosp">Gil Ivens<br />Engenheiro de Sistemas Informáticos</h4>
                <p className="p-nossosp">
                    Licenciado em Engenharia Informática pelo Instituto Superior Politécnico 
                    Independente (ISPI), 
                </p>
                <p className="p-nossosp">
                    Gil Ivens integra a OurBiz desde março de 2025. Atua no desenvolvimento e 
